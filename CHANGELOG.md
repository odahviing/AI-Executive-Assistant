...
- `.claude/agent-loop/ledger.jsonl` created — the append-only history the report cannot carry, since wrapping empties it. It is what makes charter adherence measurable rather than asserted.
