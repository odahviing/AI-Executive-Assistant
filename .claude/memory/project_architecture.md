...
---
Architecture reference for Maelle **v2.5.0** (per-thread orchestrator queue + per-turn cache + email-first booking schema; v2.4.x = floating-block + preferences catalog; v2.0.0 = Connection interface milestone).
