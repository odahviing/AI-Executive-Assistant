...
board: net +1 → 6 open rows — 2 still-real · 4 need a re-read (3 moved · 1 never examined) · 0 cite no file · 6 rulable · 0 waiting on a verb   (node scripts/ledger-stats.cjs --open)
