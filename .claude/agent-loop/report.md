...
```
out: 0 built · 0 already-fixed · 0 built-with-gap · 0 bounced · 0/0 joint-traced
board: 3 open rows — 2 still-real · 1 need a re-read · 0 cite no file · 3 rulable · 0 waiting on a verb   (node scripts/ledger-stats.cjs --open)
```
