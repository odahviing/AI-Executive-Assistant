...
- **R5 · Chase, don't nag.** A colleague who hasn't answered gets a **bounded** number of follow-ups on a sensible schedule — then the request expires, closes, and both sides are told (R4). Never infinite pinging, never silent abandonment. **"Let me check and come back to you" is not a decline** — it keeps the request open for one re-ask, then expires normally. Owner-facing pings respect his work hours.
