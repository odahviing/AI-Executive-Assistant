...
*(`C9` is vacant and is never reused. It was **"Never raise the same finding twice"** — cut 2026-08-01 in `3c67d11`; its surviving half, ref-on-the-SYMBOL-never-the-line, is under **Verdicts**. A `C9` citation dated before 2026-08-01 means that retired rule.)*
