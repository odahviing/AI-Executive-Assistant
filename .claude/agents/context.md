...
*(You own the **context budget**: the static prompt, dynamic injection, tool descriptions and learned MD. You do NOT own conversation/thread context — that's `slack` — nor `buildTurnContext` plumbing — that's `outer`.)*
