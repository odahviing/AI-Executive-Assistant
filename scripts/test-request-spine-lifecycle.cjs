...
function harness(o={}){
 ...
 const mocks={
  ...
  'src/db/jobs.ts':{completeLegacyAutomaticMoveNotice:()=>false,getOutreachJobByRequestId:()=>o.noJob?null:{id:'out_test',intent:o.intent||'meeting_reschedule',colleague_slack_id:'UPAUL',colleague_name:'Paul',colleague_tz:'UTC'},createOutreachJob:()=> 'out_test',updateOutreachJob:(id,p)=>effects.jobs.push({id,...p}),getLinkedRequestIdForOutreach:()=>row.id},
