...
- tasks       — task list / reminders / routines / briefing: "what's pending?", "what did I miss?", "show my tasks", "remind me at 4", "set up a daily routine", "what's on my brief?".
...
- Classify by meaning in any language or script, not literal examples. An attachment alone adds no scope: "summarize this image" → ['general']; a request to put the referenced item on the calendar → ['meetings'] even when its details are in the attachment.
