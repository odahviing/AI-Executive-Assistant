...
// filtered to the event id (skills/calendarHealth/handlers/checkHealth.ts:966-968 —
 ...
 * skills/outreach.ts:327 — the isFuture ternary there also produces
 * 'pending_scheduled', so it belongs in both lists),
 * 'pending_scheduled' (skills/outreach.ts:327), 'replied' (several sites in
